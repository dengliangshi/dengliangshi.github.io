...
#### 3. INPUT LEVEL
According to the composition of words, there are mainly two kinds of language. words are formed by one or more characters, like English or French; In the other kind of languages, one word is one character, such as Chinese or Korean. For the second kind of languages, there is no need to talk about the input level for language models. 
